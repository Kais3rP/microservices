module.exports = function(app){
  ...
  app.post('/api/upload', upload.single('file'), function(req, res, next){   //single() method of multer parses a single file, the paramater it takes is the name of the file specified in form input
    res.json(req.file)
